      ...
      <nav className="fixed top-0 left-0 right-0 z-50 h-[72px] bg-[#000000] border-b border-[#262626] w-full font-sans">
        ...
        <div className="flex h-full w-full items-center justify-between header-px mx-auto max-w-[1920px]">
          ...
          <div className="flex items-center">
            ...
            <a href="https://cal.com/michael-w/1clickoutcome-30-min-event" target="_blank" rel="noopener noreferrer" className="bg-white text-black hover:bg-gray-100 text-[13.5px] font-bold px-5 py-2.5 rounded-full transition-all hidden sm:flex items-center gap-1">
              Book Strategy Call <span className="text-[9px] ml-0.5">▶</span>
            </a>
            <a href="https://cal.com/michael-w/1clickoutcome-30-min-event" target="_blank" rel="noopener noreferrer" className="bg-white text-black hover:bg-gray-100 text-[12px] font-bold px-4 py-2 rounded-full transition-all sm:hidden flex items-center gap-1 ml-4">
              Book Call
            </a>
