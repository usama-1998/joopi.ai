      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-lg text-white/70">
            Whether it's deploying Emma for voice calls, Jennifer for SMS, or setting up complex CRM syncs, the workflow is always straightforward. Audit, Build, Scale.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-12 relative">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24 relative z-10">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[17px] text-white/70 leading-relaxed md:ml-14">
                We deploy Emma and Jennifer seamlessly into your ecosystem. Setting up your voice agent, SMS sequences, and deep CRM integrations requires zero technical effort on your end. 
              </p>
            </div>
            {/* Visual Side */}
