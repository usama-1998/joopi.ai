      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 border-b border-white/5 pb-12 md:pb-16 mb-12 md:mb-16">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 shrink-0 w-full md:w-auto">
            <a href="https://cal.com/michael-w/1clickoutcome-30-min-event" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white hover:bg-gray-100 text-black font-semibold px-7 py-3.5 rounded-full transition-all flex items-center justify-center gap-2 text-[14px] sm:text-[15px]">
              Book Strategy Call
