...
const testimonials: TestimonialData[] = [
  {
    ...
    name: "Mark R.",
    role: "Agency Owner",
    quote: "Before Joopi AI, we were missing calls and letting old leads slip through the cracks. Once they deployed Emma and Jennifer, we saw an immediate spike in appointments. Our revenue increased by 40% in just two months without hiring anyone new.",
    seed: "Mark",
  ...
  },
  {
    ...
    quote: "As a busy broker, I'm always on the road. Missing a call used to mean losing a commission. Since integrating Emma, the AI instantly engages leads for me. It's literally a full-time assistant that never sleeps.",
    seed: "Sarah",
  ...
  },
  {
    ...
    quote: "We were skeptical about AI handling our clients, but the natural language processing is incredible. Emma qualifies our legal leads perfectly and routes them to the right attorney's calendar without a hitch.",
    seed: "David",
